 ...
 * E.g: ActionType.ON_REQUEST_CHARACTER_LIST
 *
 * 2. ActionCall class contain class of actions with parameters of any objects.
 * E.g: class requestCharacterList(id: Int): Action(ActionType.ON_REQUEST_CHARACTER_LIST)
 *
 * 3. A Worker class is responsible for the execution of what type of action should be run after
 * the previous action
 * E.g: ActionType.ON_REQUEST_CHARACTER_LIST -> executeNextAction(Action(ActionType.REQUEST_CHARACTER_LIST))
 *
...
class GetCharacterListWorker(
    ...
    /**
     * Execute the intended request (In this case, would be character list)
     */
    fun execute(){
     ...
     * through view repository class - GetCharacterListView
     */
